...
export default class EmotionRadarChart extends PureComponent {
  render() {
      ...
      <div style={{ width: '100%', height: '100%' }}>
        <ResponsiveContainer width="100%" height="85%">
          <RadarChart cx="50%" cy="50%" outerRadius="80%" data={chartData}>
            ...
            <PolarAngleAxis dataKey="subject" tick={{ fill: '#000000', fontSize: 14 }} />
            <PolarRadiusAxis angle={30} domain={[0, 1]} tick={{ fill: '#000000', fontSize: 12 }} />
            <Radar
              name="Emotion"
              dataKey="A"
              stroke="#222"
        ...
        <div style={{ textAlign: 'center', fontSize: '14px', marginTop: '6px', color: '#333' }}>
          Le post exprime principalement de la <strong>{labelFr[dominant[0]]}</strong> ({Math.round(dominant[1] * 100)} %).
        </div>
      </div>
    );
  }
